...
if __name__ == '__main__':
    ...
    img = cv2.imread('0586.jpg', cv2.IMREAD_COLOR)
    print(img.shape)

    t = to_tensor(img).unsqueeze(0)
    n = t[0].permute(1, 2, 0).cpu().numpy()

    print(n.shape)
    niqe_result = calculate_niqe(img, crop_border=0, input_order='HWC', convert_to='y')
    print(niqe_result)

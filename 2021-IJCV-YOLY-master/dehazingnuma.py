...
class Dehaze(object):
    ...
    def _optimization_closure(self, step):
        ...
        #把计算的大气光值reshape为另外两个子网相同的大小
        self.ambient_out = self.ambient_val * torch.ones_like(self.image_out)
...
if __name__ == "__main__":
    filepath = 'data/HSTS'
    for i in os.listdir(filepath + '/synthetic'):
        folder = 'output/HSTS/' + i + '/'

    ...
    def __init__(self, img_channel=3, width=32, prompt = True,
        ...
        for num in enc_blk_nums:
            self.encoders.append(
                nn.Sequential(
                    *[CNNBlock(chan) for _ in range(num)]
                )
            )
            self.downs.append(
        ...
        self.middle = nn.Sequential(CNNBlock(width*4))
